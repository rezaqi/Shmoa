...
class Prophet extends StatefulWidget {
  const Prophet({super.key});

  @override
  State<Prophet> createState() => _ProphetState();
}

class _ProphetState extends State<Prophet> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    Get.put(ProphetsControllerImp());
    return GetBuilder<ProphetsControllerImp>(builder: (c) {
      return Scaffold(
        appBar: AppBar(
          leading: InkWell(
            onTap: () {
